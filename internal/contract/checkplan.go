...
// store 의 plan 과 같은 모양이지만 ★ 여기는 계약 패키지 ★ 라 훅도 쓸 수 있다.
type PlanDoc struct {
...
// 고친다. hook.go 가 적어둔 세 겹 중 ★ ③ 보조 ★ 의 자리다.
//
// ★ 진실의 원천이 둘이 되지 않는다 ★ — 같은 Validate() 를 부른다.
// 훅은 ★ 빠르고 불완전 ★ 하고, applyExpands 가 ★ 느리고 완전 ★ 하다.
//
//	훅이 잡는 것    계획 ★ 자체 ★ 의 모양 — 역할·필드·조건·스키마·DAG
