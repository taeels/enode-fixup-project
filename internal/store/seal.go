...
type Manifest struct {
	...
	// WorkID 는 이 Run 이 속한 Work 의 키다 (ADR-023 §6.5.2).
...
// 지어진다(재계획). 그때 "무엇을 실행했나" 에 답하려면 바뀌어 온 과정이
...
//	명령 단계 산출물이 안 걷힌 그 사고. 문서의 서술을 코드의 제약으로
//	굳히면 자리를 남긴 게 아니라 자리를 막은 것이 된다.
//
//	하한 1 은 진짜 제약이다 — Run 이 있다는 것은 누군가 무언가를 제출했다는
//	뜻이고, v1 은 제출 전문 그대로여야 한다 (성질 4).
//
// 왜 차분이 아니라 전문인가
//
...
type ContractVersion struct {
	...
	// Cause 는 무엇을 보고 바꿨나다 — 앞 단계의 결과 파일들
