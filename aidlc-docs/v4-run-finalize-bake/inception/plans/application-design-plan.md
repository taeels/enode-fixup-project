...
**Units Generation 이 고쳤다 (2026-09-24T12:09:37Z).** 제품에 사내 형식의 기본값을 두지 않고, 굽기 계약이 구울 IR 을 정확한 값으로 적는다. 노드가 그 값을 sync 에 환경 변수로 넘기고 sync 뒤 HEAD 와 대조한다 (`unit-of-work-plan.md` 2.3).
