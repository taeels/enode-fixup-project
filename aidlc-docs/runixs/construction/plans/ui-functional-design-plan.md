...
**상태**: 실 함대·데모 FD 승인 완료. queue 인수와 sandbox 출처 승인 완료.
실제 시나리오 c7a237d도 인수했다. 공개 방송 입력은 남아 있다.
...
- [x] sandbox 출처 확인: 2026-09-09 사용자가 최태양님 승인 전달.
- [x] c7a237d 고정 시나리오·LED 순서·음원 이름 주입 위치 인수.
- [ ] 방송 설정의 필요한 공용 접점 확인.
- [x] 보완한 담당 설계를 리뷰하고 그 결과 기록. 2026-09-08T20:11:36Z “응 시작해”.
