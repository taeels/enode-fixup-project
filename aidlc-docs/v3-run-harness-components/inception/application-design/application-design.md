...
```text
   ...
   ⑱  logs/ 에 init 줄과 최종 봉투만 싣는다      ⑮ 이 넓힌 누출 표면을 닫는다.
                                             전체 스트림은 짝 팩의 링으로 간다
